...
namespace Kindy.Infrastructure.Core.Repository
{
    ...
    /// 
    /// </summary>
    /// <typeparam name="TEntity">必须是实体  ，而且是聚合根。  只有聚合根才有仓库</typeparam>
    /// <typeparam name="TDbContext">DB上线文必须是我们定义的上线文，以及它的子类。将来我们就可以把我们的domain context给他</typeparam>
